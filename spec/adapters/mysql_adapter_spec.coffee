...
describe 'Norm.Adapters.MySQLAdapter', ->
  beforeEach ->
    @.addMatchers
      toBeInstanceOf: (expected) ->
        @.actual instanceof expected

  adapter = new Norm.Adapters.MySQLAdapter()

  it 'is an instance of MySQLAdapter', ->
    expect(adapter).toBeInstanceOf(Norm.Adapters.MySQLAdapter)
  ...
  describe '#insert', ->
    it 'returns a query with one attribute', ->
      ...
      expect(actual).toEqual("INSERT INTO people (first_name) VALUES ('Jim');")
    ...
    it 'returns a query with multiple attributes', ->
      ...
      criteria = new Norm.Criteria({tableName: 'people'}, {}, instances)
      actual   = adapter.insert(criteria)
      expect(actual).toEqual("INSERT INTO people (first_name,last_name) VALUES ('Jim','Drannbauer');")
    ...
    it 'returns a query with multiple attributes and multiple rows', ->
      ...
      criteria = new Norm.Criteria({tableName: 'people'}, {}, instances)
      actual   = adapter.insert(criteria)
      expect(actual).toEqual("INSERT INTO people (first_name,last_name) VALUES ('Jim','Drannbauer'),('Kerry','Drannbauer');")
    ...
    it 'returns a query with multiple mixed (NULL) attributes and multiple rows', ->
      ...
      criteria = new Norm.Criteria({ tableName: 'people' }, {}, instances)
      actual = adapter.insert(criteria)
      expect(actual).toEqual("INSERT INTO people (first_name,middle_name,last_name) VALUES ('James','William',NULL),('Kerry',NULL,'Drannbauer');")
